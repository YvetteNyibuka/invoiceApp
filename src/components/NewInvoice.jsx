...
function NewInvoice({ showModal, onClose, onSubmit }) {
  ...
  const handleFormSubmit = (e) => {
    ...
    const newId =
      Math.max(...existingInvoices.map((invoice) => invoice.id), 0) + 1;
        ...
        <form action="" id="invoiceForm" onSubmit={handleFormSubmit}>
          ...
          <div className="sec">
            ...
            <input
              ...
              name="streetAdress1"
              onChange={(e) =>
                setFormData({ ...formData, streetAdress1: e.target.value })
              }
            ...
            <div className="city">
              <div className="sec">
                ...
                <input
                  ...
                  name="city1"
                  onChange={(e) =>
                    setFormData({ ...formData, city1: e.target.value })
                  }
            ...
            <div className="postcode">
              <div className="sec">
                ...
                <input
                  ...
                  name="postCode1"
                  onChange={(e) =>
                    setFormData({ ...formData, postCode1: e.target.value })
                  }
            ...
            <div className="country">
              <div className="sec">
                ...
                <input
                  ...
                  name="country1"
                  onChange={(e) =>
                    setFormData({ ...formData, country1: e.target.value })
                  }
          ...
          <div className="sec">
            ...
            <input
              ...
              name="streetAdress2"
              onChange={(e) =>
                setFormData({ ...formData, streetAdress2: e.target.value })
              }
            ...
            <div className="postcode">
              <div className="sec">
                ...
                <input
                  ...
                  name="postCode2"
                  onChange={(e) =>
                    setFormData({ ...formData, postCode2: e.target.value })
                  }
            ...
            <div className="country">
              <div className="sec1">
                ...
                <input
                  ...
                  name="country2"
                  onChange={(e) =>
                    setFormData({ ...formData, country2: e.target.value })
                  }
